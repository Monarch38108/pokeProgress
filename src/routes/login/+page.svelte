...
<div class="min-h-screen bg-gradient-to-br from-red-500 to-red-700 flex items-center justify-center px-4">
	<div class="bg-white rounded-lg shadow-2xl p-8 w-full max-w-md">
		<div class="text-center mb-8">
			...
			<p class="text-gray-600">Sign in to track your Pokémon progress</p>
		</div>
		...
		<form action="?/login" method="POST" use:enhance class="space-y-6">
			...
			<button
               ...
               focus:ring-offset-2 transition duration-200 transform hover:scale-105"
			>
				Sign In
			</button>
		</form>
		...
		<div class="mt-6 text-center">
			<p class="text-sm text-gray-600">
				...
				<a href="/register" class="text-red-500 hover:text-red-600 font-medium">
					Sign up here
				</a>
			</p>
		</div>
